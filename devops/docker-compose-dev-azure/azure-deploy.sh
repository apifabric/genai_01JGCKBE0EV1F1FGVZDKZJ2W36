...
resourcename="airlinemanagementsystem"  # lower case, only
resourcegroup="airlinemanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/airlinemanagementsystem.git
...
az group create --name airlinemanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group airlinemanagementsystem_rg --sku S1 --is-linux
az container create --resource-group airlinemanagementsystem_rg --name airlinemanagementsystem --image apilogicserver/airlinemanagementsystem:latest --dns-name-label airlinemanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//airlinemanagementsystem.westus.azurecontainer.io:5656'
